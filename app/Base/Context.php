...
class Context
{
	 ...
	 * @param \App\Base\Config $config Configuration object
	 * @param \App\Base\Locale $locale Locale object
	 * @param \App\Base\I18n $i18n Internationalisation object
	 */
	public function __construct( \Illuminate\Session\Store $session, \App\Base\Config $config, \App\Base\Locale $locale, \App\Base\I18n $i18n )
	{
	 ...
	 *
	 * @param bool $locale True to add locale object to context, false if not (deprecated, use \App\Base\Locale)
	 * @param string $type Configuration type, i.e. "frontend" or "backend" (deprecated, use \App\Base\Config)
